...
od_matrix = np.load(f'../dataset/Manhattan_{TIME_INTERVAL}min_{start}_{end}_T_{t_sum}_Sum_7912564_最终FINAL.npy')  # [T, N, N]
adj_matrix = np.load('../dataset/adj_matrix/曼哈顿_adj_matrix_TNN.npy')              # [N, N]
dist_matrix = np.load('../dataset/adj_matrix/曼哈顿_dist_matrix_TNN.npy')            # [N, N]

# od_matrix = od_matrix[-10:]
...
np.save(f'../dataset/Manhattan_Flow_TNN_{TIME_INTERVAL}min_{start}_{end}_MSA-SUE_logit3_最终FINAL.npy', flow_results)
