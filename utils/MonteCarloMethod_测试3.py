...
# OD_完整批处理_3.17_Final_MCM_60 --》 num_samples = 13


# 蒙特卡洛模拟生成训练数据
num_samples = 42  # 生成1000个样本
T_samples = []  # 存储生成的OD矩阵
X_samples = []  # 存储对应的链路流量
...
np.save('../data/OD_完整批处理_3.17_Final_MCM_180_43.npy', OD_total)
...
np.save('../data/Speed_完整批处理_3.17_Final_MCM_180_43.npy', Speed_total)