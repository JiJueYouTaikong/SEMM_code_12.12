...
# ZINB-NN层数相关数据（更新后）
layers = [2, 4, 6, 8, 10]
rmse_layer = [9.4773, 9.4239, 9.6342, 7.1843, 8.6646]
mae_layer = [1.1589, 1.0824, 1.1079, 0.9627, 1.0518]
cpc_layer = [0.5978, 0.5975, 0.5741, 0.6571, 0.6173]
jsd_layer = [0.1213, 0.1213, 0.1225, 0.1105, 0.1172]

# ZINB-NN每层神经元数量相关数据（更新后）
neurons_labels = [64, 128, 256, 512, 1024]
neurons_idx = list(range(len(neurons_labels)))  # 均匀分布的索引
rmse_neuron = [7.4997, 7.5905, 7.1843, 7.8761, 7.6511]
mae_neuron = [0.9936, 1.0330, 0.9627, 1.0378, 1.0106]
cpc_neuron = [0.6424, 0.6458, 0.6571, 0.6379, 0.6527]
jsd_neuron = [0.1125, 0.1142, 0.1105, 0.1148, 0.1119]
