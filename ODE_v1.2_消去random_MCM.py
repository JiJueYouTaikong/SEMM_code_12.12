...
class ODModel(nn.Module):
    ...
    def forward(self, x):
        ...
        x_temp_freq_rand = np.stack([x_freq, x_temp], axis=-1)  # [B,N,2]
...
log_filename = f"log/v1_2/A完整批处理的调参MCM_withoutRandom_3.19.log"
...
def main():
    # 定义学习率列表
    lr_list = [0.1, 0.05, 0.045, 0.04, 0.035, 0.03, 0.025, 0.015, 0.01, 0.005,
               0.0045, 0.004, 0.0035, 0.003, 0.002, 0.0015, 0.001,
