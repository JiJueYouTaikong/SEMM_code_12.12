...
# from utils.get_X_Freq_FFT import get_X_Freq, get_X_Freq_MCM
# from utils.get_X_Freq_WT1 import get_X_Freq, get_X_Freq_MCM
...
log_filename = f"log/v1_2/A完整批处理的调参MCM_3.17.log"
...
def load_data():
    ...
    speed_freq = get_X_Freq(speed,3,True)
    od_freq = get_X_Freq(od_production,3,True)
    freq = (od_freq - speed_freq).astype(float)
