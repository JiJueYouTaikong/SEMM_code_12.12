...
# from utils.get_X_Freq_FFT import get_X_Freq
# from utils.get_X_Freq_WT1 import get_X_Freq
...
log_filename = f"log/v1_2/完整批处理的调参_3.17.log"
...
def load_data():
    ...
    speed_freq = get_X_Freq(speed,1,is_mcm=False)
    od_freq = get_X_Freq(od_production,1,is_mcm=False)
    freq = (od_freq - speed_freq).astype(float)
