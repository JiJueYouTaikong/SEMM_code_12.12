...
# 2. 数据加载与预处理
# 加载数据
speed_data = np.load('data/WH_Speed_1km_110region.npy')  # 形状为[168, 110]
...
# 3. 初始化模型、损失函数和优化器
model = LSTMModel(input_size=110, hidden_size=128, output_size=110*110, num_layers=2)
...
print(real_od_avg[74:82, 74:82].astype(int))
print("--------------------------------------------------")
print(predicted_od_avg[74:82, 74:82].astype(int))
