...
def load_predictions():
    ...
    methods = {
        ...
        "SEMM": "./可视化/测试集TNN/Pred_ours_ZINB.npy",




        "OVS-MCM": "./可视化/测试集TNN/Pred-OVS-MCM.npy",
        "Random Forest-MCM": "./可视化/测试集TNN/Pred_randomforest_True.npy",
        "Xgboost-MCM": "./可视化/测试集TNN/pred_xgb_True.npy",
...
def evaluate_all_methods_with_peak_offpeak():
    ...
    for method, pred in predictions_dict.items():
        ...
        rmse, mae, mape, cpc, jsd = evaluate_metrics(pred_offpeak, real_offpeak)
        results_offpeak[method] = (rmse, mae, mape, cpc, jsd)
    ...
    for method, pred in predictions_dict.items():
        ...
        rmse, mae, mape, cpc, jsd = evaluate_metrics(pred_peak, real_peak)
        results_peak[method] = (rmse, mae, mape, cpc, jsd)
        print(f"{method:<15} {rmse:<8.4f} {mae:<8.4f} {mape:<8.4f} {cpc:<8.4f} {jsd:<8.4f}")

    # print("\n" + "=" * 90)
    # print("所有时段评估结果 (All hours):")
    # print(f"{'Method':<15} {'RMSE':<8} {'MAE':<8} {'MAPE':<8} {'CPC':<8} {'JSD':<8}")
    # print("-" * 90)
    #
    # results_all = {}
    ...
    #     # results_all[method] = (rmse, mae, mape, cpc, jsd)
    #     print(f"{method:<15} {rmse:<8.4f} {mae:<8.4f} {mape:<8.4f} {cpc:<8.4f} {jsd:<8.4f}")
    #
    # return results_offpeak, results_peak
...
def evaluate_all_methods():
    ...
    special_methods = {"ANN", "ANN-MCM", "OVS", "OVS-MCM","DeepGravity", "DeepGravity-MCM", "DS", "DS-MCM", "GPT2", "GPT2-MCM", "SEMM", "SEMM-MCSM"}
